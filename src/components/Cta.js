...
const Cta = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center text-white cta">
      <div className="mx-8 w-full h-auto text-center lg:text-left py-16 px-12 flex flex-col lg:flex-row lg:justify-between items-center">
        <div className="w-full flex flex-col lg:flex-row lg:justify-around mb-8 lg:mb-0">
          ...
          <div className="w-full lg:w-72 pt-6 lg:mx-12 mb-4 lg:mb-0">
        ...
        <div className="w-full lg:w-72 pt-6 lg:mx-12">
          ...
          <form onSubmit={handleSubscribe}>
            <input
              ...
              className="mt-1 mb-2 block w-full px-3 py-2 border border-red-500 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
              style={{ backgroundColor: 'white', color: 'black' }} // Ensures input is above other elements
