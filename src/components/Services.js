            ...
            <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    ...
                    <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">
                        Our comprehensive web development services cater to diverse needs and technologies.
                    </h2>
                </div>
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over 5 years of experience in web development and expertise in creating responsive websites, we are dedicated to crafting tailored digital solutions for our clients. Our team excels in designing and developing dynamic web portals that empower clients to obtain websites precisely aligned with their needs. Whether you're looking for a bespoke solution or a platform that adapts seamlessly across all devices, we are committed to delivering exceptional, high-quality results that drive success and meet your unique requirements.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    We collaborate with your existing tech team to scale software applications or design customized solutions tailored to your specific needs. Our collaborative approach ensures seamless integration and optimized performance.
                                </p>
                            </div>
                        </div>
                    </div>
